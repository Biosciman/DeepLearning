...
bilstm1 = bilstmLayer(numHiddenUnits,OutputMode="last",Name='bilstm1');
bilstm2 = bilstmLayer(numHiddenUnits,OutputMode="last",Name='bilstm2');
bilstm3 = bilstmLayer(numHiddenUnits,OutputMode="last",Name='bilstm3');

lgraph = layerGraph(layers);
lgraph = addLayers(lgraph,bilstm1)
lgraph = addLayers(lgraph,bilstm2)
lgraph = addLayers(lgraph,bilstm3)
lgraph = connectLayers(lgraph,'relu_1','bilstm1');
lgraph = connectLayers(lgraph,'bilstm1','bilstm2');
lgraph = connectLayers(lgraph,'bilstm2','bilstm3');
lgraph = connectLayers(lgraph,'bilstm3','add/in2');
...
% F1
% 
% save(sprintf('T6SS_LSTM_Model_V35_acc_%.4f.mat',acc)); 
