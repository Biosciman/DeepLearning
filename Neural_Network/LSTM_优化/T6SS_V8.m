...
% reluLayer更改为leakyReluLayer
% convolution1dLayer设置为Padding=[0 1]
% maxPooling1dLayer更改为averagePooling1dLayer
% lstmLayer变为bilstmLayer
clear;clc;close all;
...
layers = [ ...
    ...
    convolution1dLayer(filterSize,numFilters,Padding=[0 1])
    leakyReluLayer
    averagePooling1dLayer(poolSize, Stride=5)
...
save(sprintf('T6SS_LSTM_Model_V8_acc_%.4f.mat',acc)); 
